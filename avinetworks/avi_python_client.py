...
def create_avi_endpoint():
    ...
    logging.debug("Creating AVI EndPoint")
...
def create_avi_pool(session, action):
    ...
    vpApicEpgName = params['apic_epg_name']
...
def create_avi_virtualservice(session, app_profile_name, action):
    ...
    vsVip = params['vipIp']
    vsApicContractGraph = params['apic_contract_graph']
    ...
    if action == 'MODIFY':
        ...
        vs_obj = {
            ...
            'services' : service_objs,
            'apic_contract_graph': vsApicContractGraph,
            'pool_ref' : pool_ref,
            'application_profile_ref' : app_profile_ref,
